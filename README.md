...
Our client is a company with over 30 years in the heavy construction materials market in Mexico. Their product mix spans the steel industry — corrugated rebar, wire rod, and wire — through to cement and concrete.
...
## Dataset
> Dataset used is anonymized for privacy purposes.
...
on-run-start:
  ...
  - "LOAD bigquery;"
  - "ATTACH 'project={{ env_var(\"GCP_PROJECT_ID\") }}' AS bq (TYPE bigquery, READ_ONLY);"
